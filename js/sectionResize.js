function sectionResize (w, h, min, max) {

  var header = document.getElementsByTagName ('header')[0];
  var section = document.getElementsByTagName ('section')[0];

  var availableHeight = window.innerHeight - header.clientHeight;
  if (availableHeight > max) {
    availableHeight = max;
  }

  var proposedHeight = window.innerWidth * h/w;
  var proposedWidth = availableHeight / (h/w);

  if (availableHeight > min) {
